...
- reads of any `SKILL.md` file (project `.prime/agent/skills/`, user-level `~/.prime/agent/skills/`, or the bundled skills inside the `prime-agent` npm package)
- `await rlm(...)` briefs that name a skill path
